                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    @forelse (Cart::getContent() as $item)
                        <div class="product-cart">
                            ...
                            <div class="one-eight text-center">
                                <div class="display-tc">
                                    <input type="number" class="form-control input-number input-quantity text-center"
                                        data-product-id="{{ $item->id }}" value="{{ $item->quantity }}">
                                </div>
                            </div>
                            <div class="one-eight text-center">
                                <div class="display-tc">
                                    <span class="price unit-price">{{ number_format($item->quantity * $item->price) }}
                                        đ</span>
                                </div>
                            </div>
                            <div class="one-eight text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-md-push-1 text-center">
                                <div class="total">
                                    <div class="grand-total">
                                        <p>Tổng cộng:
                                            <span style="margin: 0; width: auto; padding: 0" class="total-pay">
                                        ...
                                        @if (Session::get('coupon'))
                                            ...
                                            @php
                                                echo '<p><span><strong>Thành tiền: </strong></span> <span style="width: auto" class="cart-total">' . number_format($bill, 0, ',', '.') . '</span>  đ</p>';
                                            @endphp
                                        @else
                                            @php
                                                echo '<p><span><strong>Thành tiền: </strong></span><span style="width: auto" class="cart-total">' . number_format(Cart::getTotal(), 0, ',', '.') . '</span> đ</p>';
                                            @endphp
                                        @endif

                                        <a href="{{ number_format(Cart::getTotal()) == 0 ? '/cart' : '/checkout' }}"
                                            class="btn btn-primary payment">Thanh toán <i
                                                class="icon-arrow-right-circle"></i></a>
                                        <a href="/cart/removeAll" class="btn btn-danger">Xóa giỏ hàng <i
                                                class="icon-arrow-right-circle"></i></a>
